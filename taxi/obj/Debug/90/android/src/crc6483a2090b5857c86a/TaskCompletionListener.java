...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Taxi.EventListerners.TaskCompletionListener, Taxi", TaskCompletionListener.class, __md_methods);
	}
	...
	public TaskCompletionListener ()
	{
		...
		if (getClass () == TaskCompletionListener.class)
			mono.android.TypeManager.Activate ("Taxi.EventListerners.TaskCompletionListener, Taxi", "", this, new java.lang.Object[] {  });
	}
